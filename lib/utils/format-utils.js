 ...
 *
 * @param {Object} videoDetails - The video details object containing author information, retrieved from `ytdl.getInfo()`.
 ...
 * optionally sorts the thumbnails by resolution.
 *
 * @param {Object} videoDetails - The video details object containing video information, retrieved from `ytdl.getInfo()`.
 * @param {boolean} [sort=true] - Whether to sort the thumbnails by resolution. Defaults to `true`.
 *
 ...
 *
 * @param {Object} videoDetails - The details of the video containing author and video information,
 *                                retrieved from `ytdl.getInfo()`.
 * @param {boolean} [sort=true] - Whether to sort the thumbnails by resolution. Defaults to `true`.
 *
 ...
 * @since 2.0.0
 */
function getThumbnailByResolution(videoDetails, resolutionType) {
 ...
 *
 * If the `resolutionType` is not provided, the function will use 'high' as the default resolution type.
 * This type prioritizes the 'maxresdefault' thumbnail if available, otherwise falls back to 'sddefault'.
 *
 * @param {Object} videoDetails 
 * @param {'low' | 'medium' | 'high' | 'max'} [resolutionType]
 *
 * @returns {ThumbnailObject | null}
 *
 * @throws {InvalidTypeError} If the resolution type is invalid.
 *
 * @memberof module:utils/format-utils~FormatUtils
 ...
 * @since 2.0.0
 */
function getThumbnail(videoDetails, resolutionType) {
  ...
  return getThumbnailByResolution(videoDetails, resolutionType);
}
