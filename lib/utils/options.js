...
const _AudioConverterOptions = {
  inputOptions: ['array', defaults.AudioConverterOptions.inputOptions],
  outputOptions: ['array', defaults.AudioConverterOptions.outputOptions],
    ...
    if (key in inOpts) {
      ...
      // Handle multiple type checks
        ...
        for (const type of expectedType) {
          ...
          if (typeof value !== 'undefined') break;  // Break loop after found the expected value
        }
