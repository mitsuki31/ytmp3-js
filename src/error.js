 ...
 *
 * @param   {string} signal - A signal name such as `SIGINT` or `SIGTERM`
 * @returns {number} The corresponding Unix exit code, or `1` if the signal is unrecognized
 *
 * @package
 * @since   2.0.0
 */
function getExitCodeFromSignal(signal) {
